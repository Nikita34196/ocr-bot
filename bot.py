...
MODES = {
    'auto': {
        'name': '🔍 Авто',
        'system': None,
        'prompt': "Распознай текст на фото. Выводи только сам текст без каких-либо комментариев, пояснений и вступлений."
    },
    'handwritten': {
        'name': '✍️ Рукописный',
        'system': None,
        'prompt': "Распознай рукописный текст на фото. Выводи только сам текст без каких-либо комментариев, пояснений и вступлений. Если слово неразборчиво — напиши [?]."
    },
    'printed': {
        'name': '📄 Печатный',
        'system': None,
        'prompt': "Распознай печатный текст на фото. Если текст в колонках — сначала левая, потом правая. Выводи только сам текст без каких-либо комментариев и пояснений."
    },
    'mixed': {
        'name': '📝 Смешанный',
        'system': None,
        'prompt': "Распознай весь текст на фото — и печатный и рукописный. Выводи только сам текст в порядке чтения без каких-либо комментариев и пояснений."
    }
}
